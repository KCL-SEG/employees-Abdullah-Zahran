...
class Employee:
    ...
    def __str__(self):
        if self.salary:
            ...
            if self.commissionType == 1:
                return self.name + " works on a contract of "+str(self.hours)+" hours at "+str(self.rate)+"/hour and receives a bonus commission of "+str(self.bonus)+".  Their total pay is "+str(self.pay)+"."
            elif self.commissionType == 2:
                return self.name + " works on a contract of "+str(self.hours)+" hours at "+str(self.rate)+"/hour and receives a commission for "+str(self.contracts)+" contract(s) at "+str(self.commission)+"/contract.  Their total pay is "+str(self.pay)+"."
            else:
                return self.name + " works on a contract of "+str(self.hours)+" hours at "+str(self.rate)+"/hour.  Their total pay is "+str(self.pay)+"."
